            ...
            <div className="content">
              <div className="columns">
                <div className="column is-three-quarters">
                  ...
                  <p>
                    I am in the process of tidying up this site — it's been a
                    cobweb for a long time!.
                  </p>

                  <p>
                    To start with the individual recipes will have their own
                    file — what this means is that when you want to print it out
                    you get what you want and not a large file with lots of
                    recipes! This also makes the use of a printer-friendly
                    version of the cascading style sheet work sensibly - you get
                    black ink on a white background and not much else - which is
                    what you want I hope.
                  </p>

                  <p>
                    Try the Spanakopita link to see what I mean, and try the
                    File | Print Preview on your browser Press Close to return
                    to normal browsing). Then the back button on your browser
                    (or the left mouse button) can get you back to this page.
                  </p>
